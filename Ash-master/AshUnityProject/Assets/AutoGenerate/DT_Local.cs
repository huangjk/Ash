...
namespace Ash
{
	...
	/// </summary>>
    public partial class TestDataTables : IReloadableDataTables
    {
        /// <summary>
        ...
        internal static TestDataTables _instance = new TestDataTables();
        Dictionary<int, TestDataTable> _dict = new Dictionary<int, TestDataTable>();
        ...
        /// <summary>
        /// Do reload the dataTable file: Test, no exception when duplicate primary key
        /// </summary>
        ...
        /// <summary>
        /// Do reload the dataTable class : Test, no exception when duplicate primary key, use custom string content
        /// </summary>
        ...
        public static TestDataTable Get(int primaryKey)
        {
            TestDataTable dataTable;
        ...
        public static bool HasDataRow(int primaryKey)
        {
        ...
        /// <returns>是否存在数据表行。</returns>
        public static bool HasDataRow(System.Predicate<TestDataTable> condition)
        {
            if (condition == null)
            {
        ...
        public static TestDataTable[] GetAllDataRows(System.Predicate<TestDataTable> condition)
        {
            if (condition == null)
            {
                throw new System.Exception("Condition is invalid.");
        ...
        public static TestDataTable[] GetAllDataRows(System.Comparison<TestDataTable> comparison)
        {
            if (comparison == null)
            {
            ...
            List<TestDataTable> allDataRows = new List<TestDataTable>();
            foreach (var dataRow in GetInstance()._dict)
            {
	...
	/// </summary>
	public partial class TestDataTable : TableRowFieldParser
	{
        ...
        { 
            Id = row.Get_int(row.Values[0], "int"); 
            Value = row.Get_string(row.Values[1], ""); 
            Value2 = row.Get_float(row.Values[2], ""); 
        }
