...
namespace Ash.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = Type.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Utility.Path.GetCombinePath(Application.dataPath, "Ash.Core/Configs/BuildSettings.xml");
        ...
        /// 将构建场景设置为默认。
        /// </summary>
        [MenuItem("Ash Framework/Scenes in Build Settings/Default Scenes", false, 20)]
        ...
        /// 将构建场景设置为所有。
        /// </summary>
        [MenuItem("Ash Framework/Scenes in Build Settings/All Scenes", false, 21)]
