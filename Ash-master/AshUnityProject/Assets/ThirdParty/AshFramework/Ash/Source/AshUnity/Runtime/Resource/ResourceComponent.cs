...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Resource")]
    public sealed partial class ResourceComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "Ash.Runtime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "Ash.Runtime.DefaultLoadResourceAgentHelper";
        ...
        private void OnResourceInitComplete(object sender, Ash.Core.Resource.ResourceInitCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceInitCompleteEventArgs>().Fill(e));
        }

        private void OnVersionListUpdateSuccess(object sender, Ash.Core.Resource.VersionListUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<VersionListUpdateSuccessEventArgs>().Fill(e));
        }

        private void OnVersionListUpdateFailure(object sender, Ash.Core.Resource.VersionListUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<VersionListUpdateFailureEventArgs>().Fill(e));
        }

        private void OnResourceCheckComplete(object sender, Ash.Core.Resource.ResourceCheckCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceCheckCompleteEventArgs>().Fill(e));
        }

        private void OnResourceUpdateStart(object sender, Ash.Core.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateStartEventArgs>().Fill(e));
        }

        private void OnResourceUpdateChanged(object sender, Ash.Core.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateChangedEventArgs>().Fill(e));
        }

        private void OnResourceUpdateSuccess(object sender, Ash.Core.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateSuccessEventArgs>().Fill(e));
        }

        private void OnResourceUpdateFailure(object sender, Ash.Core.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateFailureEventArgs>().Fill(e));
        }

        private void OnResourceUpdateAllComplete(object sender, Ash.Core.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
