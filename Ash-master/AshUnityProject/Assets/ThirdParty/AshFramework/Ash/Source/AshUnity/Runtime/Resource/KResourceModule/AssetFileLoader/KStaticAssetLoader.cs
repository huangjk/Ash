...
namespace Ash.Runtime
{
    ...
    public class StaticAssetLoader : AbstractResourceLoader
    {
        ...
        public static StaticAssetLoader Load(string url, AssetFileLoader.AssetFileBridgeDelegate callback = null)
        {
            ...
            return AutoNew<StaticAssetLoader>(url, newCallback, false);
        }
