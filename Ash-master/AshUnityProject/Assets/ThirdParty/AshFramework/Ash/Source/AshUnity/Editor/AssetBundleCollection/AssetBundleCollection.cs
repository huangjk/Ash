...
namespace Ash.Editor.AssetBundleTools
{
    ...
    internal sealed class AssetBundleCollection
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<AssetBundleCollectionConfigPathAttribute>() ?? Utility.Path.GetCombinePath(Application.dataPath, "Ash.Core/Configs/AssetBundleCollection.xml");
