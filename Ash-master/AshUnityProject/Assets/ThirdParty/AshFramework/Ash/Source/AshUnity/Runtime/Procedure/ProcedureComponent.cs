...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Procedure")]
    public sealed class ProcedureComponent : AshUnityComponent
    {
        private IProcedureManager m_ProcedureManager = null;
        private ProcedureBase m_EntranceProcedure = null;

        [HideInInspector]
        public string[] m_AvailableProcedureTypeNames = null;

        [HideInInspector]
        public string m_EntranceProcedureTypeName = null;
