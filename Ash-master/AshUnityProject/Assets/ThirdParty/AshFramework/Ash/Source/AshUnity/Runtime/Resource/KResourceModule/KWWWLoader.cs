...
namespace Ash.Runtime
{
    ...
    {
        private LoadResourceAgentHelperBase m_loadResourceAgentHelper;
        ...
        protected override void Init(string url, params object[] args)
        {
            ...
            if (CachedWWWLoaderMonitorCoroutine == null)
            {
                ...
                KResourceLoader.Instance.StartCoroutine(CachedWWWLoaderMonitorCoroutine);
            }
        }

        protected void StartLoad()
        {
            KResourceLoader.Instance.StartCoroutine(CoLoad(Url)); //开启协程加载Assetbundle，执行Callback
        }
        ...
        protected static IEnumerator WWWLoaderMonitorCoroutine()
        {
            ...
            {
                if (KResourceLoader.LoadByQueue)
                {
                    while (GetCount<KWWWLoader>() != 0)
                        yield return null;
                }
            ...
            KResourceLoader.Instance.StopCoroutine(CachedWWWLoaderMonitorCoroutine);
