...
namespace Ash.Game.Editor
{
    [CustomEditor(typeof(MyGameEntry))]
    internal class MyGameEntryInspector : AshInspector
    {
        ...
        private void ProcedureInspector()
        {
            MyGameEntry t = (MyGameEntry)target;
            ProcedureComponent procedureComponent = t.procedureComponent;
            ...
            {
                EditorGUILayout.LabelField("Current Procedure", procedureComponent.CurrentProcedure == null ? "None" : procedureComponent.CurrentProcedure.GetType().ToString());
            }
        ...
        {
            string[] assemblyNames = new string[] { "Ash.Game" };
            m_ProcedureTypeNames = Ash.Editor.Type.GetTypeNames(typeof(Ash.Core.Procedure.ProcedureBase), assemblyNames);
