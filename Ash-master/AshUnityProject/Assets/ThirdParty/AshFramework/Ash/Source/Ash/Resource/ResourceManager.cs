...
namespace Ash.Core.Resource
{
    ...
    /// 资源管理器。
    /// </summary>
    internal sealed partial class ResourceManager : AshModule, IResourceManager
    {
        ...
        /// <summary>
        /// 资产名字 + AssetInfo（资产名字、ResourceName(资源名字、变体名称)）
        /// </summary>
        private readonly Dictionary<string, AssetInfo> m_AssetInfos;
        /// <summary>
        /// 资产名字 + AssetDependencyInfo（资产名字、互相引用的关联资产、离散的关联资产）
        /// </summary>
        ...
        public int UpdateRetryCount
        {
            ...
            set
            {
                ...
                {
                    throw new AshException("You can not use UpdateRetryCount at this time.");
                }
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            ...
            {
                throw new AshException("Readonly path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new AshException("You must set readonly path before add load resource agent helper.");
            }
        ...
        public void SetReadWritePath(string readWritePath)
        {
            ...
            {
                throw new AshException("Read-write path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new AshException("You must set read-write path before add load resource agent helper.");
            }
        ...
        public void SetCurrentVariant(string currentVariant)
        {
            ...
            {
                throw new AshException("You can net set current variant at this time.");
            }
        ...
        public void UpdateVersionList(int versionListLength, int versionListHashCode, int versionListZipLength, int versionListZipHashCode)
        {
            ...
            if (m_VersionListProcessor == null)
            {
                throw new AshException("You can not use UpdateVersionList at this time.");
            }
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            {
                throw new AshException("Load asset callbacks is invalid.");
            }
        ...
        public void LoadScene(string sceneAssetName, LoadSceneCallbacks loadSceneCallbacks)
        {
            ...
            {
                throw new AshException("Scene asset name is invalid.");
            }

            if (loadSceneCallbacks == null)
            {
                throw new AshException("Load scene callbacks is invalid.");
            }
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks)
        {
            ...
            {
                throw new AshException("Unload scene callbacks is invalid.");
            }
        ...
        public bool GetResourceGroupReady(string resourceGroupName)
        {
            ...
            {
                throw new AshException(string.Format("Can not find resource group '{0}'.", resourceGroupName));
            }
