...
namespace Ash.Core.Entity
{
    ...
    /// 实体管理器。
    /// </summary>
    internal sealed partial class EntityManager : AshModule, IEntityManager
    {
        ...
        internal override void Update(float elapseSeconds, float realElapseSeconds)
        {
            while (m_RecycleQueue.Count > 0)
            {
                ...
                if (entityGroup == null)
                {
                    throw new AshException("Entity group is invalid.");
                }
        ...
        public bool HasEntityGroup(string entityGroupName)
        {
            ...
            {
                throw new AshException("Entity group name is invalid.");
            }
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper)
        {
            ...
            {
                throw new AshException("Entity group helper is invalid.");
            }
        ...
        public bool HasEntity(string entityAssetName)
        {
            ...
            {
                throw new AshException("Entity asset name is invalid.");
            }
        ...
        public void ShowEntity(int entityId, string entityAssetName, string entityGroupName, object userData)
        {
            ...
            {
                throw new AshException("You must set entity helper first.");
            }
            ...
            {
                throw new AshException(string.Format("Entity id '{0}' is already exist.", entityId.ToString()));
            }

            EntityGroup entityGroup = (EntityGroup)GetEntityGroup(entityGroupName);
            if (entityGroup == null)
            {
                throw new AshException(string.Format("Entity group '{0}' is not exist.", entityGroupName));
            }
            ...
            if (entityInstanceObject == null)
            {
                ...
                {
                    throw new AshException(string.Format("Entity '{0}' is already being loaded.", entityId.ToString()));
                }
        ...
        public void HideEntity(int entityId, object userData)
        {
            ...
            if (entityInfo == null)
            {
                throw new AshException(string.Format("Can not find entity '{0}'.", entityId.ToString()));
            }
        ...
        public IEntity GetParentEntity(int childEntityId)
        {
            ...
            {
                throw new AshException(string.Format("Can not find child entity '{0}'.", childEntityId.ToString()));
            }
        ...
        public IEntity GetParentEntity(IEntity childEntity)
        {
            if (childEntity == null)
            {
                throw new AshException("Child entity is invalid.");
            }
        ...
        public IEntity[] GetChildEntities(int parentEntityId)
        {
            ...
            {
                throw new AshException(string.Format("Can not find parent entity '{0}'.", parentEntityId.ToString()));
            }
        ...
        public IEntity[] GetChildEntities(IEntity parentEntity)
        {
            ...
            {
                throw new AshException("Parent entity is invalid.");
            }
        ...
        public void AttachEntity(int childEntityId, int parentEntityId, object userData)
        {
            ...
            {
                throw new AshException(string.Format("Can not attach entity when child entity status is '{0}'.", childEntityInfo.Status.ToString()));
            }
            ...
            {
                throw new AshException(string.Format("Can not attach entity when parent entity status is '{0}'.", parentEntityInfo.Status.ToString()));
            }
        ...
        public void DetachEntity(int childEntityId, object userData)
        {
            ...
            if (parentEntityInfo == null)
            {
                throw new AshException(string.Format("Can not find parent entity '{0}'.", parentEntity.Id.ToString()));
            }
        ...
        private void InternalShowEntity(int entityId, string entityAssetName, EntityGroup entityGroup, object entityInstance, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (entity == null)
                {
                    throw new AshException("Can not create entity in helper.");
                }
        ...
        private void InternalHideEntity(EntityInfo entityInfo, object userData)
        {
            ...
            {
                throw new AshException("Entity info is unmanaged.");
            }
        ...
        private void LoadEntitySuccessCallback(string entityAssetName, object entityAsset, float duration, object userData)
        {
            ...
            {
                throw new AshException("Show entity info is invalid.");
            }
