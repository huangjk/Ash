...
namespace Ash.GameMain
{
    public class MyGame : AshGameEntry
    {
        ...
        {
            //必要组件------
            //m_SettingComponent = AshUnityEntry.Instance.GetAshComponent<SettingComponent>();
            ...
            Log.Info("AshTestSettings:  "  + AshTestSettings.GetAllDataRows(x => {return x.Age == 20;}).Length);
        }
        ...
        public override void OnGameUpdate()
        {
            ...
            {
                var m_DebuggerComponent = AshUnityEntry.Instance.GetAshComponent<DebuggerComponent>();
