...
namespace Ash.Core.Sound
{
    /// <summary>
    /// 声音管理器。
    /// </summary>
    internal sealed partial class SoundManager : AshModule, ISoundManager
    {
        ...
        public void SetSoundHelper(ISoundHelper soundHelper)
        {
            if (soundHelper == null)
            {
                throw new AshException("Sound helper is invalid.");
            }
        ...
        public bool HasSoundGroup(string soundGroupName)
        {
            ...
            {
                throw new AshException("Sound group name is invalid.");
            }
        ...
        public bool AddSoundGroup(string soundGroupName, bool soundGroupAvoidBeingReplacedBySamePriority, bool soundGroupMute, float soundGroupVolume, ISoundGroupHelper soundGroupHelper)
        {
            ...
            {
                throw new AshException("Sound group helper is invalid.");
            }
        ...
        public void AddSoundAgentHelper(string soundGroupName, ISoundAgentHelper soundAgentHelper)
        {
            ...
            {
                throw new AshException("You must set sound helper first.");
            }

            SoundGroup soundGroup = (SoundGroup)GetSoundGroup(soundGroupName);
            if (soundGroup == null)
            {
                throw new AshException(string.Format("Sound group '{0}' is not exist.", soundGroupName));
            }
        ...
        public void PauseSound(int serialId, float fadeOutSeconds)
        {
            ...
            throw new AshException(string.Format("Can not find sound '{0}'.", serialId.ToString()));
        }
        ...
        private void LoadSoundSuccessCallback(string soundAssetName, object soundAsset, float duration, object userData)
        {
            ...
            {
                throw new AshException("Play sound info is invalid.");
            }
