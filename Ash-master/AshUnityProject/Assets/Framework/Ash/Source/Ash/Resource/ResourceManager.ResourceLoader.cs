    ...
    internal partial class ResourceManager
    {
        ...
        private sealed partial class ResourceLoader
        {
            ...
            public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks, object userData)
            {
                ...
                {
                    throw new AshException("You must set resource helper first.");
                }
                ...
                {
                    throw new AshException(string.Format("Can not find asset of scene '{0}'.", sceneAssetName));
                }
            ...
            private bool LoadDependencyAsset(string assetName, LoadResourceTaskBase mainTask, object userData)
            {
                if (mainTask == null)
                {
                    throw new AshException("Main task is invalid.");
                }
