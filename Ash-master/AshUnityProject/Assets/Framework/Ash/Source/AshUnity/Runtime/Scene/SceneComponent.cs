...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Scene")]
    public sealed class SceneComponent : AshUnityComponent
    {
        ...
        private void OnLoadSceneUpdate(object sender, Ash.Core.Scene.LoadSceneUpdateEventArgs e)
        {
        ...
        private void OnLoadSceneDependencyAsset(object sender, Ash.Core.Scene.LoadSceneDependencyAssetEventArgs e)
        {
