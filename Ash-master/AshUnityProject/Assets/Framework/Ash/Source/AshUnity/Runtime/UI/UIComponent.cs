...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/UI")]
    public sealed partial class UIComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "Ash.Runtime.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "Ash.Runtime.DefaultUIGroupHelper";
        ...
        private void OnOpenUIFormSuccess(object sender, Ash.Core.UI.OpenUIFormSuccessEventArgs e)
        {
        ...
        private void OnOpenUIFormFailure(object sender, Ash.Core.UI.OpenUIFormFailureEventArgs e)
        {
        ...
        private void OnOpenUIFormUpdate(object sender, Ash.Core.UI.OpenUIFormUpdateEventArgs e)
        {
        ...
        private void OnOpenUIFormDependencyAsset(object sender, Ash.Core.UI.OpenUIFormDependencyAssetEventArgs e)
        {
        ...
        private void OnCloseUIFormComplete(object sender, Ash.Core.UI.CloseUIFormCompleteEventArgs e)
        {
