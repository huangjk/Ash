...
namespace Ash.Runtime
{
    ...
    public sealed partial class AshUnityEntry : MonoBehaviour
    {
        ...
        /// </summary>
        public static AshUnityEntry New(GameObject gameObjectToAttach, IGameEntry entry, bool showComponentsInHierarchy = false)
        {
            ...
            AshUnityEntry ashUnityEntry = gameObjectToAttach.AddComponent<AshUnityEntry>();
        ...
        {
            InitLogHelper();
            Log.Info("AshCore version is {0}. AshUnity version is {1}.", AshEntry.Version, Version);
