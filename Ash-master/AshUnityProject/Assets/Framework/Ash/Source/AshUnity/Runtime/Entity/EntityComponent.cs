...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Entity")]
    public sealed partial class EntityComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "Ash.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "Ash.Runtime.DefaultEntityGroupHelper";
        ...
        private void OnShowEntitySuccess(object sender, Ash.Core.Entity.ShowEntitySuccessEventArgs e)
        {
        ...
        private void OnShowEntityFailure(object sender, Ash.Core.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, Ash.Core.Entity.ShowEntityUpdateEventArgs e)
        {
        ...
        private void OnShowEntityDependencyAsset(object sender, Ash.Core.Entity.ShowEntityDependencyAssetEventArgs e)
        {
        ...
        private void OnHideEntityComplete(object sender, Ash.Core.Entity.HideEntityCompleteEventArgs e)
        {
