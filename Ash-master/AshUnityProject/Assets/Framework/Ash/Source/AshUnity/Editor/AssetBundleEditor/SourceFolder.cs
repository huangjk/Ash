...
namespace Ash.Editor.AssetBundleTools
{
    internal sealed class SourceFolder
    {
        ...
        public SourceFolder GetFolder(string name)
        {
            ...
            {
                throw new AshException("Source folder name is invalid.");
            }
        ...
        public SourceFolder AddFolder(string name)
        {
            ...
            if (folder != null)
            {
                throw new AshException("Source folder is already exist.");
            }
        ...
        public SourceAsset GetAsset(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new AshException("Source asset name is invalid.");
            }
        ...
        public SourceAsset AddAsset(string guid, string path, string name)
        {
            ...
            {
                throw new AshException("Source asset guid is invalid.");
            }

            if (string.IsNullOrEmpty(path))
            {
                throw new AshException("Source asset path is invalid.");
            }
            ...
            if (asset != null)
            {
                throw new AshException(string.Format("Source asset '{0}' is already exist.", name));
            }
