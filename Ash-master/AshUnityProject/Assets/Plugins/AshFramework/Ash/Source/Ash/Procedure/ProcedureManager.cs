...
namespace Ash.Core.Procedure
{
    /// <summary>
    /// 流程管理器。
    /// </summary>
    internal sealed class ProcedureManager : AshModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                ...
                {
                    throw new AshException("You must initialize procedure first.");
                }
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            if (fsmManager == null)
            {
                throw new AshException("FSM manager is invalid.");
            }
