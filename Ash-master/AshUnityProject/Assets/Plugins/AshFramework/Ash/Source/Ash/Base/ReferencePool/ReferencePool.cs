...
namespace Ash.Core
{
    ...
    public static class ReferencePool
    {
        ...
        public static void Clear(Type referenceType)
        {
            ...
            {
                throw new AshException("Reference type is invalid.");
            }

            if (!referenceType.IsClass || referenceType.IsAbstract)
            {
                throw new AshException("Reference type is not a non-abstract class type.");
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new AshException(string.Format("Reference type '{0}' is invalid.", referenceType.FullName));
            }
        ...
        public static void Release<T>(T reference) where T : class, IReference
        {
            if (reference == null)
            {
                throw new AshException("Reference is invalid.");
            }
        ...
        public static void Release(Type referenceType, IReference reference)
        {
            ...
            {
                throw new AshException(string.Format("Reference type '{0}' not equals to reference's type '{1}'.", referenceType.FullName, type.FullName));
            }
