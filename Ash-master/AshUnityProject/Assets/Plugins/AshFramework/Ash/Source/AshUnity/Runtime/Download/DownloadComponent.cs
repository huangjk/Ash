...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Download")]
    public sealed class DownloadComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "Ash.Runtime.UnityWebRequestDownloadAgentHelper";
        ...
        private void OnDownloadStart(object sender, Ash.Core.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadStartEventArgs>().Fill(e));
        }

        private void OnDownloadUpdate(object sender, Ash.Core.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadUpdateEventArgs>().Fill(e));
        }

        private void OnDownloadSuccess(object sender, Ash.Core.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadSuccessEventArgs>().Fill(e));
        }

        private void OnDownloadFailure(object sender, Ash.Core.Download.DownloadFailureEventArgs e)
        {
