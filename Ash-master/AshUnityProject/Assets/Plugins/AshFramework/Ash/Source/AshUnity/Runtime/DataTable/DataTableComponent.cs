...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Data Table")]
    public sealed class DataTableComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "Ash.Runtime.DefaultDataTableHelper";
        ...
        private void OnLoadDataTableSuccess(object sender, Ash.Core.DataTable.LoadDataTableSuccessEventArgs e)
        {
        ...
        private void OnLoadDataTableFailure(object sender, Ash.Core.DataTable.LoadDataTableFailureEventArgs e)
        {
        ...
        private void OnLoadDataTableUpdate(object sender, Ash.Core.DataTable.LoadDataTableUpdateEventArgs e)
        {
        ...
        private void OnLoadDataTableDependencyAsset(object sender, Ash.Core.DataTable.LoadDataTableDependencyAssetEventArgs e)
        {
