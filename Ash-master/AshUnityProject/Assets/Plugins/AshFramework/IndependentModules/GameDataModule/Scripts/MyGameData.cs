...
namespace Ash
{
    ...
    {
        internal static MyGameData _instance = null;
        ...
        /// 配置定位器
        /// </summary>
        private IGameDataLocator locator;

        /// <summary>
        /// 类型转换器
        /// </summary>
        private Converters m_Converters;
        ...
        public MyGameData(IGameDataLocator locator)
        {
            if (locator== null)
            {
            ...
            this.m_Converters = Converters.GetInstance();
        ...
        /// </summary>
        /// <param name="locator">配置定位器</param>
        public void SetLocator(IGameDataLocator locator)
        {
            if (locator == null)
            {
                throw new System.ArgumentNullException();
        ...
        {
            if (locator == null || m_Converters == null|| name == null)
            {
                throw new System.ArgumentNullException();
            }

            locator.Set((string)name, m_Converters.Convert<string>(value));
        ...
        public T Get<T>(string name, T def = default(T))
        {
            ...
            T result;
            return m_Converters.TryConvert(val, out result) ? result : def;
        }
    }
}