...
namespace Ash
{
    ...
    /// </summary>
    public class DTMySqlModule : DTMySqlModuleBase
    {
        ...
        /// Singleton
        /// </summary>
        private static DTMySqlModule _instance;
