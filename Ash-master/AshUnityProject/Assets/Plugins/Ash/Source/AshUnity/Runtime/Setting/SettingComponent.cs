...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Setting")]
    public sealed class SettingComponent : AshUnityComponent
    {
        private ISettingManager m_SettingManager = null;

        [SerializeField]
        private string m_SettingHelperTypeName = "Ash.Runtime.DefaultSettingHelper";
