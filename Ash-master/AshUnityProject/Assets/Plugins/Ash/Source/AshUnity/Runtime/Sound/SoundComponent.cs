...
#if UNITY_5_3
using Ash.Core.Scene;
#endif
using Ash.Core.Sound;
using UnityEngine;
...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Sound")]
    public sealed partial class SoundComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "Ash.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "Ash.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "Ash.Runtime.DefaultSoundAgentHelper";
        ...
        private void OnPlaySoundUpdate(object sender, Ash.Core.Sound.PlaySoundUpdateEventArgs e)
        {
        ...
        private void OnPlaySoundDependencyAsset(object sender, Ash.Core.Sound.PlaySoundDependencyAssetEventArgs e)
        {
        ...
        private void OnLoadSceneFailure(object sender, Ash.Core.Scene.LoadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
        ...
        private void OnUnloadSceneFailure(object sender, Ash.Core.Scene.UnloadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
