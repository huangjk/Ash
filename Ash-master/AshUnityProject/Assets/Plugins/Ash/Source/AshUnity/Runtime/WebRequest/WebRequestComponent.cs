...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Web Request")]
    public sealed class WebRequestComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "Ash.Runtime.UnityWebRequestAgentHelper";
        ...
        private void OnWebRequestStart(object sender, Ash.Core.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<WebRequestStartEventArgs>().Fill(e));
        }

        private void OnWebRequestSuccess(object sender, Ash.Core.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<WebRequestSuccessEventArgs>().Fill(e));
        }

        private void OnWebRequestFailure(object sender, Ash.Core.WebRequest.WebRequestFailureEventArgs e)
        {
