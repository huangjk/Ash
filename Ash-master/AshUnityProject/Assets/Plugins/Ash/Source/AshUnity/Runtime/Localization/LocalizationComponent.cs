...
namespace Ash.Runtime
{
    ...
    [AddComponentMenu("Ash Framework/Localization")]
    public sealed class LocalizationComponent : AshUnityComponent
    {
        ...
        [SerializeField]
        private string m_LocalizationHelperTypeName = "Ash.Runtime.DefaultLocalizationHelper";
        ...
        private void OnLoadDictionarySuccess(object sender, Ash.Core.Localization.LoadDictionarySuccessEventArgs e)
        {
        ...
        private void OnLoadDictionaryFailure(object sender, Ash.Core.Localization.LoadDictionaryFailureEventArgs e)
        {
        ...
        private void OnLoadDictionaryUpdate(object sender, Ash.Core.Localization.LoadDictionaryUpdateEventArgs e)
        {
        ...
        private void OnLoadDictionaryDependencyAsset(object sender, Ash.Core.Localization.LoadDictionaryDependencyAssetEventArgs e)
        {
