...
namespace Ash.Editor
{
    ...
    internal static class OpenFolder
    {
        ...
        /// </summary>
        [MenuItem("Ash Framework/Open Folder/Temporary Cache Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("Ash Framework/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("Ash Framework/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("Ash Framework/Open Folder/Data Path", false, 13)]
        ...
        private static void InternalOpenFolder(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                case RuntimePlatform.OSXEditor:
                    ...
                    break;
                default:
                    throw new AshException(string.Format("Not support open folder on '{0}' platform.", Application.platform.ToString()));
            }
        }
    }
}
