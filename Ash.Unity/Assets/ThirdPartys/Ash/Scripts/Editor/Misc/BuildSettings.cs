...
namespace AshUnityEditor
{
    ...
    {
        private const string ConfigurationName = "ThirdPartys/Ash/Configs/BuildSettings.xml";
        ...
        /// 将构建场景设置为默认。
        /// </summary>
        [MenuItem("Window/Ash/Scenes in Build Settings/Default Scenes", false, 20)]
        ...
        /// 将构建场景设置为所有。
        /// </summary>
        [MenuItem("Window/Ash/Scenes in Build Settings/All Scenes", false, 21)]
