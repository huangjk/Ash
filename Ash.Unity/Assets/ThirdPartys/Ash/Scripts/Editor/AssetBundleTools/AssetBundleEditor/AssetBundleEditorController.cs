...
namespace AshUnityEditor.AssetBundleTools
{
    ...
    {
        private const string ConfigurationName = "ThirdPartys/Ash/Configs/AssetBundleEditor.xml";
        ...
        public event AshAction<SourceAsset[]> OnAssetAssigned = null;

        public event AshAction<SourceAsset[]> OnAssetUnassigned = null;
