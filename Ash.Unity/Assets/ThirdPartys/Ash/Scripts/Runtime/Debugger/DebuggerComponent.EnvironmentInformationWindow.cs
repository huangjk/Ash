...
namespace AshUnity
{
    public partial class DebuggerComponent
    {
        ...
        {
            private AshBase m_BaseComponent = null;
            private ResourceComponent m_ResourceComponent = null;

            public override void Initialize(params object[] args)
            {
                m_BaseComponent = AshApp.GetComponent<AshBase>();
                ...
                m_ResourceComponent = AshApp.GetComponent<ResourceComponent>();
...
#endif
                    DrawItem("Ash Version:", AshEntry.Version.ToString());
                    DrawItem("Unity Ash Version:", AshApp.AshUnityVersion.ToString());
