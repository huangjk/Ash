...
namespace AshUnity
{
    ...
    public sealed partial class DebuggerComponent : AshComponent
    {
        /// <summary>
        /// 默认调试器漂浮框大小。
        /// </summary>
        ...
        protected override void Awake()
        {
            ...
            m_DebuggerManager = AshEntry.GetModule<IDebuggerManager>();
        ...
        private void Start()
        {
            ...
            if (AshApp.GetComponent<ObjectPoolComponent>() != null)
            {
        ...
        private void OnGUI()
        {
            ...
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>Ash DEBUGGER</b>");
            }
            else
            {
