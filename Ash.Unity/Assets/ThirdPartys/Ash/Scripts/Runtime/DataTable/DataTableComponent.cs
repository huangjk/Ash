...
namespace AshUnity
{
    ...
    [AddComponentMenu("Ash/Data Table")]
    public sealed class DataTableComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "AshUnity.DefaultDataTableHelper";
        ...
        protected override void Awake()
        {
            ...
            m_DataTableManager.AddDataRow += OnAddDataRow;
            m_DataTableManager.UpdateDataRow += OnUpdateDataRow;
            m_DataTableManager.DeleteDataRow += OnDeleteDataRow;
        }
        ...
        private void Start()
        {
            ...
            {
                m_DataTableManager.SetResourceManager(AshEntry.GetModule<IResourceManager>());
            }
        ...
        private void OnLoadDataTableSuccess(object sender, Ash.DataTable.LoadDataTableSuccessEventArgs e)
        {
        ...
        private void OnLoadDataTableFailure(object sender, Ash.DataTable.LoadDataTableFailureEventArgs e)
        {
        ...
        private void OnLoadDataTableUpdate(object sender, Ash.DataTable.LoadDataTableUpdateEventArgs e)
        {
        ...
        private void OnLoadDataTableDependencyAsset(object sender, Ash.DataTable.LoadDataTableDependencyAssetEventArgs e)
        {
        ...
        private void OnDeleteDataRow(object sender, Ash.DataTable.DeleteDataRowEventArgs e)
        {
            m_EventComponent.Fire(sender, new AshUnity.DeleteDataRowEventArgs(e));
        }

        private void OnUpdateDataRow(object sender, Ash.DataTable.UpdateDataRowEventArgs e)
        {
            m_EventComponent.Fire(sender, new AshUnity.UpdateDataRowEventArgs(e));
        }

        private void OnAddDataRow(object sender, Ash.DataTable.AddDataRowEventArgs e)
        {
            m_EventComponent.Fire(sender, new AshUnity.AddDataRowEventArgs(e));
        }
    }
}
