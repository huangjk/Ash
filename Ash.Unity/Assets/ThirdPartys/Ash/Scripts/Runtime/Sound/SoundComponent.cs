...
namespace AshUnity
{
    ...
    [AddComponentMenu("Ash/Sound")]
    public sealed partial class SoundComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "AshUnity.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "AshUnity.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "AshUnity.DefaultSoundAgentHelper";
        ...
        private void OnPlaySoundSuccess(object sender, Ash.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, Ash.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, Ash.Sound.PlaySoundUpdateEventArgs e)
        {
        ...
        private void OnPlaySoundDependencyAsset(object sender, Ash.Sound.PlaySoundDependencyAssetEventArgs e)
        {
