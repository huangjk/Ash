...
namespace AshUnity
{
    ...
    public sealed partial class ResourceComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "AshUnity.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "AshUnity.DefaultLoadResourceAgentHelper";
        ...
        private void Start()
        {
            ...
            m_ResourceManager = m_EditorResourceMode ? baseComponent.EditorResourceHelper : AshEntry.GetModule<IResourceManager>();
            ...
            if(baseComponent.RuningMode == RuningMode.Product)
                m_ResourceManager.SetReadOnlyPath(BuildPath.Instance.resourceFolder);
            else
        ...
        private void OnResourceInitComplete(object sender, Ash.Resource.ResourceInitCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceInitCompleteEventArgs(e));
        }

        private void OnVersionListUpdateSuccess(object sender, Ash.Resource.VersionListUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, new VersionListUpdateSuccessEventArgs(e));
        }

        private void OnVersionListUpdateFailure(object sender, Ash.Resource.VersionListUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, new VersionListUpdateFailureEventArgs(e));
        }

        private void OnResourceCheckComplete(object sender, Ash.Resource.ResourceCheckCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceCheckCompleteEventArgs(e));
        }

        private void OnResourceUpdateStart(object sender, Ash.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceUpdateStartEventArgs(e));
        }

        private void OnResourceUpdateChanged(object sender, Ash.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceUpdateChangedEventArgs(e));
        }

        private void OnResourceUpdateSuccess(object sender, Ash.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceUpdateSuccessEventArgs(e));
        }

        private void OnResourceUpdateFailure(object sender, Ash.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, new ResourceUpdateFailureEventArgs(e));
        }

        private void OnResourceUpdateAllComplete(object sender, Ash.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
