...
namespace AshUnity
{
    ...
    [AddComponentMenu("Ash/Network")]
    public sealed partial class NetworkComponent : AshComponent
    {
        private INetworkManager m_NetworkManager = null;
        private EventComponent m_EventComponent = null;

        [SerializeField]
        private string m_NetworkHelperTypeName = "AshUnity.DefaultNetworkHelper";
        ...
        private void OnNetworkConnected(object sender, Ash.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, new NetworkConnectedEventArgs(e));
        }

        private void OnNetworkClosed(object sender, Ash.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, new NetworkClosedEventArgs(e));
        }

        private void OnNetworkSendPacket(object sender, Ash.Network.NetworkSendPacketEventArgs e)
        {
            m_EventComponent.Fire(this, new NetworkSendPacketEventArgs(e));
        }

        private void OnNetworkMissHeartBeat(object sender, Ash.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, new NetworkMissHeartBeatEventArgs(e));
        }

        private void OnNetworkError(object sender, Ash.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, new NetworkErrorEventArgs(e));
        }

        private void OnNetworkCustomError(object sender, Ash.Network.NetworkCustomErrorEventArgs e)
        {
