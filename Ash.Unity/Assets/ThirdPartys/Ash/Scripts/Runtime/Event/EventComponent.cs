...
namespace AshUnity
{
    ...
    public sealed class EventComponent : AshComponent
    {
        ...
        public bool Check(EventId id, EventHandler<AshEventArgs> handler)
        {
        ...
        public void Subscribe(EventId id, EventHandler<AshEventArgs> handler)
        {
        ...
        public void Unsubscribe(EventId id, EventHandler<AshEventArgs> handler)
        {
        ...
        {
            new Dictionary<int, EventHandler<AshEventArgs>>();
        }
