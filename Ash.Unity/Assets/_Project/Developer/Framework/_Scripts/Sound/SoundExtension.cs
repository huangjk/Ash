...
namespace Framework
{
    public static class SoundExtension
    {
        ...
        public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
        {
            ...
            Entry.Setting.SetBool(string.Format(Constant.Setting.SoundGroupMuted, soundGroupName), mute);
            Entry.Setting.Save();
        }
        ...
        public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
        {
            ...
            Entry.Setting.SetFloat(string.Format(Constant.Setting.SoundGroupVolume, soundGroupName), volume);
            Entry.Setting.Save();
        }
    }
}
