...
namespace Framework
{
    public static class UIExtension
    {
        ...
        public static int? OpenUIForm<T>(this UIComponent uiComponent, UIFormId uiFormId, object userData = null) where T : UGuiForm
        {
            return uiComponent.OpenUIForm<T>((int)uiFormId, userData);
        }

        public static int? OpenUIForm<T>(this UIComponent uiComponent, int uiFormId, object userData = null) where T : UGuiForm
        {
            IDataTable<DRUIForm> dtUIForm = Entry.DataTable.GetDataTable<DRUIForm>();
            DRUIForm drUIForm = dtUIForm.GetDataRow(uiFormId);
            if (drUIForm == null)
