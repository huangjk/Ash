...
#pragma warning disable 0067, 0414
        ...
        /// 资源初始化完成事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceInitCompleteEventArgs> ResourceInitComplete = null;

        /// <summary>
        /// 版本资源列表更新成功事件。
        /// </summary>
        public event EventHandler<Ash.Resource.VersionListUpdateSuccessEventArgs> VersionListUpdateSuccess = null;

        /// <summary>
        /// 版本资源列表更新失败事件。
        /// </summary>
        public event EventHandler<Ash.Resource.VersionListUpdateFailureEventArgs> VersionListUpdateFailure = null;

        /// <summary>
        /// 资源检查完成事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceCheckCompleteEventArgs> ResourceCheckComplete = null;

        /// <summary>
        /// 资源更新开始事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceUpdateStartEventArgs> ResourceUpdateStart = null;

        /// <summary>
        /// 资源更新改变事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceUpdateChangedEventArgs> ResourceUpdateChanged = null;

        /// <summary>
        /// 资源更新成功事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceUpdateSuccessEventArgs> ResourceUpdateSuccess = null;

        /// <summary>
        /// 资源更新失败事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceUpdateFailureEventArgs> ResourceUpdateFailure = null;

        /// <summary>
        /// 资源更新全部完成事件。
        /// </summary>
        public event EventHandler<Ash.Resource.ResourceUpdateAllCompleteEventArgs> ResourceUpdateAllComplete = null;
        ...
        private void Awake()
        {
            ...
            AshBase baseComponent = GetComponent<AshBase>();
