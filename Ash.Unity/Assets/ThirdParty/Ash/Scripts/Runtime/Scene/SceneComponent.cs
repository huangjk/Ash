...
namespace AshUnity
{
    ...
    public sealed class SceneComponent : AshComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_AshScene = UnityEngine.SceneManagement.SceneManager.GetSceneAt(AshApp.AshSceneId);
            if (!m_AshScene.IsValid())
            {
                Log.Fatal("Ash scene is invalid.");
                return;
            }
        }
        ...
        private void OnLoadSceneSuccess(object sender, Ash.Scene.LoadSceneSuccessEventArgs e)
        {
            ...
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene() == m_AshScene)
            {
