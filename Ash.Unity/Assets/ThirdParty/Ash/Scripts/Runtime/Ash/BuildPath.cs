...
namespace AshUnity
{
    ...
    {
        private static BuildPath m_Instance = null;

        public static BuildPath Instance
        {
            get
            {
                if (m_Instance == null)
                    m_Instance = new BuildPath();
                return m_Instance;
            }
        }
            ...
            get
            {
                switch (Application.platform)
                {
                    ...
                    case RuntimePlatform.IPhonePlayer:  //Iphone
                        return string.Concat(Application.persistentDataPath, "/Product/");
                    case RuntimePlatform.OSXEditor: //MAC
                    case RuntimePlatform.OSXPlayer:
                    case RuntimePlatform.WindowsEditor: //windows
                    case RuntimePlatform.WindowsPlayer:
                        return string.Concat(Application.dataPath, "/../Product/");
                    default:
                        return string.Concat(Application.dataPath, "/../Product/");
