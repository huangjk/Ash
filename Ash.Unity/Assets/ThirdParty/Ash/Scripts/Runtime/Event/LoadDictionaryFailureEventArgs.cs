...
namespace AshUnity
{
    ...
    /// 加载字典失败事件。
    /// </summary>
    public sealed class LoadDictionaryFailureEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化加载字典失败事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public LoadDictionaryFailureEventArgs(Ash.Localization.LoadDictionaryFailureEventArgs e)
        {
