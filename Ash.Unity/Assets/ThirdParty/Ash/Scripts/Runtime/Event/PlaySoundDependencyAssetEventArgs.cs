...
namespace AshUnity
{
    ...
    /// 播放声音时加载依赖资源事件。
    /// </summary>
    public sealed class PlaySoundDependencyAssetEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化播放声音时加载依赖资源事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public PlaySoundDependencyAssetEventArgs(Ash.Sound.PlaySoundDependencyAssetEventArgs e)
        {
