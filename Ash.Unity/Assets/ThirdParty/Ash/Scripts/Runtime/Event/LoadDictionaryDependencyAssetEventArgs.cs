...
namespace AshUnity
{
    ...
    /// 加载字典时加载依赖资源事件。
    /// </summary>
    public sealed class LoadDictionaryDependencyAssetEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化加载字典时加载依赖资源事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public LoadDictionaryDependencyAssetEventArgs(Ash.Localization.LoadDictionaryDependencyAssetEventArgs e)
        {
