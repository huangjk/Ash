...
namespace AshUnity
{
    ...
    /// 加载场景时加载依赖资源事件。
    /// </summary>
    public sealed class LoadSceneDependencyAssetEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化加载场景时加载依赖资源事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public LoadSceneDependencyAssetEventArgs(Ash.Scene.LoadSceneDependencyAssetEventArgs e)
        {
