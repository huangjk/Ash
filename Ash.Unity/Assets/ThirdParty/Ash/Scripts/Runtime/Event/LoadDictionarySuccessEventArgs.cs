...
namespace AshUnity
{
    ...
    /// 加载字典成功事件。
    /// </summary>
    public sealed class LoadDictionarySuccessEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化加载字典成功事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public LoadDictionarySuccessEventArgs(Ash.Localization.LoadDictionarySuccessEventArgs e)
        {
