...
namespace AshUnity
{
    ...
    public sealed class UIForm : MonoBehaviour, IUIForm
    {
        ...
        public void OnInit(int serialId, string uiFormAssetName, IUIGroup uiGroup, bool pauseCoveredUIForm, bool isNewInstance, object userData)
        {
            ...
            ShowUIInfo showUIInfo = (ShowUIInfo)userData;

            Type uiLogicType = showUIInfo.UILogicType;
            ...
            m_UIFormLogic = gameObject.AddComponent(uiLogicType) as UIFormLogic;
            if (m_UIFormLogic == null)
            {
                Log.Fatal("Can not get UI form logic. type: '{0}'" , uiLogicType);
                return;
            }
