    ...
    public class NewBehaviourScript : MonoBehaviour
    {
        ...
        void Start()
        {
            try
            {
                ...
                sql.InsertInto("momo", new string[] { "name", "qq", "email", "blog" }, new string[] { "sdsad", "213123", "ruoruo@gmail.com", "xuanyusong.com" });
                ...
                sql.UpdateInto("momo", new string[] { "name", "qq" }, new string[] { "'aaa'", "'4444444'" }, "email", "'ruoruo@gmail.com'");
