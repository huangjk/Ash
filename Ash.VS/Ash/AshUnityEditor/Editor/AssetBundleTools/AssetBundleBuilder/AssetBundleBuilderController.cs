...
namespace AshUnityEditor.AssetBundleTools
{
    ...
    {
        private const string ConfigurationName = "Ash/Configs/AssetBundleBuilder.xml";
        ...
        public bool Load()
        {
            ...
            try
            {
                ...
                XmlNode xmlRoot = xmlDocument.SelectSingleNode("UnityAsh");
        ...
        public bool Save()
        {
            ...
            try
            {
                ...
                XmlElement xmlRoot = xmlDocument.CreateElement("UnityAsh");
