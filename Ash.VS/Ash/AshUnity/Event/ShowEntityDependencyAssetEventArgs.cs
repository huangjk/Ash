...
namespace AshUnity
{
    ...
    /// 显示实体时加载依赖资源事件。
    /// </summary>
    public sealed class ShowEntityDependencyAssetEventArgs : AshEventArgs
    {
        /// <summary>
        /// 初始化显示实体时加载依赖资源事件的新实例。
        /// </summary>
        /// <param name="e">内部事件。</param>
        public ShowEntityDependencyAssetEventArgs(Ash.Entity.ShowEntityDependencyAssetEventArgs e)
        {
