...
namespace AshUnity
{
    ...
    public sealed class WebRequestComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "AshUnity.UnityWebRequestAgentHelper";
        ...
        private void OnWebRequestStart(object sender, Ash.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, new WebRequestStartEventArgs(e));
        }

        private void OnWebRequestSuccess(object sender, Ash.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, new WebRequestSuccessEventArgs(e));
        }

        private void OnWebRequestFailure(object sender, Ash.WebRequest.WebRequestFailureEventArgs e)
        {
