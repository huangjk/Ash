...
namespace UnityAsh.Runtime
{
    ...
    public sealed partial class SoundComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "UnityAsh.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "UnityAsh.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "UnityAsh.Runtime.DefaultSoundAgentHelper";
