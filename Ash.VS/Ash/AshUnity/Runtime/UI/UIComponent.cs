...
namespace AshUnity
{
    ...
    [AddComponentMenu("Ash/UI")]
    public sealed partial class UIComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "AshUnity.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "AshUnity.DefaultUIGroupHelper";
        ...
        private void Start()
        {
            ...
            {
                m_UIManager.SetResourceManager(AshEntry.GetModule<IResourceManager>());
            }

            m_UIManager.SetObjectPoolManager(AshEntry.GetModule<IObjectPoolManager>());
        ...
        public int OpenUIForm(Type uiLogicType, string uiFormAssetName, string uiGroupName)
        {
            return OpenUIForm(uiLogicType,uiFormAssetName, uiGroupName,false,null);
        }
        ...
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(Type uiLogicType, string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm)
        {
            return OpenUIForm(uiLogicType,uiFormAssetName, uiGroupName, pauseCoveredUIForm,null);
        }
        ...
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(Type uiLogicType,string uiFormAssetName, string uiGroupName, object userData)
        {
            return OpenUIForm(uiLogicType, uiFormAssetName, uiGroupName, false, userData);
        }
        ...
        private void OnOpenUIFormSuccess(object sender, Ash.UI.OpenUIFormSuccessEventArgs e)
        {
        ...
        private void OnOpenUIFormFailure(object sender, Ash.UI.OpenUIFormFailureEventArgs e)
        {
        ...
        private void OnOpenUIFormUpdate(object sender, Ash.UI.OpenUIFormUpdateEventArgs e)
        {
        ...
        private void OnOpenUIFormDependencyAsset(object sender, Ash.UI.OpenUIFormDependencyAssetEventArgs e)
        {
        ...
        private void OnCloseUIFormComplete(object sender, Ash.UI.CloseUIFormCompleteEventArgs e)
        {
