...
namespace AshUnity
{
    ...
    public sealed class DownloadComponent : BaseComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "AshUnity.UnityWebRequestDownloadAgentHelper";
        ...
        private void OnDownloadStart(object sender, Ash.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, new DownloadStartEventArgs(e));
        }

        private void OnDownloadUpdate(object sender, Ash.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, new DownloadUpdateEventArgs(e));
        }

        private void OnDownloadSuccess(object sender, Ash.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, new DownloadSuccessEventArgs(e));
        }

        private void OnDownloadFailure(object sender, Ash.Download.DownloadFailureEventArgs e)
        {
