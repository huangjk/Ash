...
namespace AshUnity
{
    ...
    public sealed partial class EntityComponent : AshComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "AshUnity.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "AshUnity.DefaultEntityGroupHelper";
        ...
        private void OnShowEntitySuccess(object sender, Ash.Entity.ShowEntitySuccessEventArgs e)
        {
        ...
        private void OnShowEntityFailure(object sender, Ash.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, Ash.Entity.ShowEntityUpdateEventArgs e)
        {
        ...
        private void OnShowEntityDependencyAsset(object sender, Ash.Entity.ShowEntityDependencyAssetEventArgs e)
        {
        ...
        private void OnHideEntityComplete(object sender, Ash.Entity.HideEntityCompleteEventArgs e)
        {
