...
namespace Ash
{
    ...
    internal sealed partial class Dispatcher
    {
        ...
        internal int Count
        {
            get
            {
                return handlers.Count + wildcardHandlers.Count;
            }
        }
        ...
        public IAshEventHandler On(string eventName, Func<object, object> handler, int life = 0)
        {
            ...
            var eventHandler = new EventHandler(this, wildcard ? RegexUtil.AsteriskWildcard(eventName) : eventName, handler, life, wildcard);
