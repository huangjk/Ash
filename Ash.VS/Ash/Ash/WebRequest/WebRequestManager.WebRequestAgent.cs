namespace Ash.WebRequest
{
    internal partial class WebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public AshAction<WebRequestAgent> WebRequestAgentStart;
            public AshAction<WebRequestAgent, byte[]> WebRequestAgentSuccess;
            public AshAction<WebRequestAgent, string> WebRequestAgentFailure;
