...
namespace Ash.DataTable
{
    ...
    {
        event EventHandler<AddDataRowEventArgs> AddDataRowEvent;
        event EventHandler<UpdateDataRowEventArgs> UpdateDataRowEvent;
        event EventHandler<DeleteDataRowEventArgs> DeleteDataRowEvent;
        ...
        /// 增加数据表行。
        /// </summary>
        /// <param name="dataRowText">Row的类型。</param>
        void AddDataRow(T row);

        void DeleteDataRow(int id);

        void UpdateDataRow(T row);
    }
}
