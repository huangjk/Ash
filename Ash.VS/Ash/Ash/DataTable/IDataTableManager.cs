...
namespace Ash.DataTable
{
    ...
    public interface IDataTableManager
    {
        ...
        event EventHandler<AddDataRowEventArgs> AddDataRow;
        event EventHandler<DeleteDataRowEventArgs> DeleteDataRow;
        event EventHandler<UpdateDataRowEventArgs> UpdateDataRow;
