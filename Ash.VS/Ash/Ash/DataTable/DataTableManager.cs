...
namespace Ash.DataTable
{
    ...
    internal sealed partial class DataTableManager : AshModule, IDataTableManager
    {
        ...
        private EventHandler<AddDataRowEventArgs> m_AddDataRowEventHandler;
        private EventHandler<DeleteDataRowEventArgs> m_DeleteDataRowEventHandler;
        private EventHandler<UpdateDataRowEventArgs> m_UpdateDataRowEventHandler;
        ...
        public event EventHandler<AddDataRowEventArgs> AddDataRow
        {
            add
            {
                m_AddDataRowEventHandler += value;
            }
        ...
        public event EventHandler<UpdateDataRowEventArgs> UpdateDataRow
        {
            add
            {
                m_UpdateDataRowEventHandler += value;
            }
        ...
        public event EventHandler<DeleteDataRowEventArgs> DeleteDataRow
        {
            add
            {
                m_DeleteDataRowEventHandler += value;
            }
        ...
        public IDataTable<T> CreateDataTable<T>(string name, string text) where T : class, IDataRow, new()
        {
            ...
            dataTable.AddDataRowEvent += OnAddDataRowEvent;
            dataTable.UpdateDataRowEvent += OnUpdateDataRowEvent;
            dataTable.DeleteDataRowEvent += OnDeleteDataRowEvent;
        ...
        private void OnDeleteDataRowEvent(object sender, DeleteDataRowEventArgs e)
        {
            if(m_DeleteDataRowEventHandler!=null)
            {
                m_DeleteDataRowEventHandler(sender, e);
            }
        }

        private void OnUpdateDataRowEvent(object sender, UpdateDataRowEventArgs e)
        {
            if (m_UpdateDataRowEventHandler != null)
            {
                m_UpdateDataRowEventHandler(sender, e);
            }
        }

        private void OnAddDataRowEvent(object sender, AddDataRowEventArgs e)
        {
            if (m_AddDataRowEventHandler != null)
            {
                m_AddDataRowEventHandler(sender, e);
            }
        }
    }
}
