...
namespace Ash.Resource
{
    internal partial class ResourceManager
    {
        ...
        private sealed class VersionListProcessor
        {
            ...
            public AshAction<string, string> VersionListUpdateSuccess;
            public AshAction<string, string> VersionListUpdateFailure;
            ...
            public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion)
            {
                ...
                if (!System.IO.File.Exists(versionListFileName))
                {
