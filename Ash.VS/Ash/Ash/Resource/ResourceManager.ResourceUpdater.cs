...
namespace Ash.Resource
{
    internal partial class ResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public AshAction<ResourceName, string, string, int, int, int> ResourceUpdateStart;
            public AshAction<ResourceName, string, string, int, int> ResourceUpdateChanged;
            public AshAction<ResourceName, string, string, int, int> ResourceUpdateSuccess;
            public AshAction<ResourceName, string, int, int, string> ResourceUpdateFailure;
            public AshAction ResourceUpdateAllComplete;
            ...
            public void SetDownloadManager(IDownloadManager downloadManager)
            {
                ...
                {
                    throw new AshException("Download manager is invalid.");
                }
            ...
            public void UpdateResources()
            {
                if (m_DownloadManager == null)
                {
                    throw new AshException("You must set download manager first.");
                }

                if (!m_CheckResourcesComplete)
                {
                    throw new AshException("You must check resources complete first.");
                }
            ...
            private void GenerateReadWriteList()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new AshException(string.Format("Pack save exception '{0}'.", exception.Message), exception);
                }
                finally
                {
                    if (fileStream != null)
            ...
            private void OnDownloadSuccess(object sender, DownloadSuccessEventArgs e)
            {
                ...
                byte[] bytes = System.IO.File.ReadAllBytes(e.DownloadPath);
                ...
                if (zip)
                {
                    ...
                    System.IO.File.WriteAllBytes(e.DownloadPath, bytes);
                }
                ...
                {
                    throw new AshException(string.Format("Resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
                ...
                {
                    throw new AshException(string.Format("Read-write resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
            ...
            private void OnDownloadFailure(object sender, DownloadFailureEventArgs e)
            {
                ...
                if (System.IO.File.Exists(e.DownloadPath))
                {
                    System.IO.File.Delete(e.DownloadPath);
                }
                ...
                if (updateInfo.RetryCount < m_RetryCount)
                {
                    ...
                    {
                        throw new AshException("Update state error.");
                    }
                }
            }
        }
